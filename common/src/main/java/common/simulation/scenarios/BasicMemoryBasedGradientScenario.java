 ...
 * @author babbarshaer
 */
public class BasicMemoryBasedGradientScenario extends Scenario{
...
//            };
            ...
            SimulationScenario.StochasticProcess bootstrapUtilizationManager = new SimulationScenario.StochasticProcess() {
                {
                    eventInterArrivalTime(constant(100));
                    raise(1, Operations.bootstrapUtilizationHandler, constant(6000));
                }
            };
...
//            process2.startAfterStartOf(2000,process1);
//            process3.startAfterStartOf(2000,process2);
...
//         terminateProcess.startAfterTerminationOf(1000*1000, process1);
    ...
    // -------------------------------------------------------------------
    public BasicMemoryBasedGradientScenario() {
        super(scenario);
    }
