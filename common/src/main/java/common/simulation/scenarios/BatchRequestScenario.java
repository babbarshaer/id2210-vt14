    ...
    private static SimulationScenario scenario = new SimulationScenario() {
        {
            ...
            SimulationScenario.StochasticProcess batchRequestTest1 = new SimulationScenario.StochasticProcess() {
                {
                    eventInterArrivalTime(constant(1000));
                    raise(1,Operations.batchRequest(),
                            uniform(0,Integer.MAX_VALUE),
                            constant(3),constant(2),constant(2000),constant(1500)
                            );
                }
            };
...
//           testProcess2.startAfterTerminationOf(100, peerAdd0);
            ...
            batchRequestTest1.startAfterTerminationOf(5000, peerAdd0);
